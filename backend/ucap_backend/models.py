...
class CO_PO_Mapping(models.Model):
    mapping_program_outcome_id = models.ForeignKey(ProgramOutcome, on_delete=models.CASCADE)
    mapping_course_outcome_id = models.ForeignKey(CourseOutcome, on_delete=models.CASCADE)
